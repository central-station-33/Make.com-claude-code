...
import { Home, Settings, MessageSquare, LayoutDashboard, ChartBar, PauseCircle, MapPin, Building2 } from "lucide-react";
...
const SidebarNav = () => {
  ...
  return (
    <nav className="space-y-6 px-2">
      ...
      <div className="space-y-1">
        <div className="px-3 py-2">
          <h3 className="text-xs font-semibold text-muted-foreground">Rental Leasing</h3>
        </div>
